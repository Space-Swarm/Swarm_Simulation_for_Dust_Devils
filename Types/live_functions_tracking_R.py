...
def pre_initialise_types(X,Y,robot_speed,R, types_array,lattice_constants,G):
    '''
    Loading the swarm positions based on given position, robot speed and desired seperation distance
    ...
    for x,y in zip(X,Y):
        ...
        #appending the robot objects
        swarm.append(Robot(x,y,1,0,0,robot_speed, walk_time,heading,types_array[cnt],R,lattice_constants,G))
